...
class PrimeiroTempoResultadoParser:
    """Parser especialista em extrair os dados do card de 1º Tempo - Resultado."""

    @staticmethod
    def parse(element: WebElement, comp_name: str, match: Match) -> Optional[PrimeiroTempoResultadoMarket]:
        try:
            ...
            if "1º Tempo - Resultado" not in market_title:
                return None
            ...
            return PrimeiroTempoResultadoMarket(
            ...
            print(f"Erro ao fazer parse do mercado 1º Tempo - Resultado para o jogo {match.home_team}: {e}")
            return None
